...
-- Ajouter les colonnes tenant_id aux tables existantes
ALTER TABLE `events`
...
-- Ajouter les index pour event_staff (maintenant que la colonne tenant_user_id existe)
ALTER TABLE `event_staff`
