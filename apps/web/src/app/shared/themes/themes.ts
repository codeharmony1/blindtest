...
export const PREDEFINED_THEMES: ThemeConfig[] = [
  // === THÈMES MARIAGE ===
  {
    ...
    description:
      "Élégance automnale raffinée avec des tons terracotta, ambre et ivoire",
    category: "wedding",
    colors: {
      primary: "#B85C47", // Terracotta élégant
      secondary: "#D4A574", // Ambre doré
      accent: "#E8B969", // Or miel
      background: "#FAF7F2", // Ivoire chaud
      surface: "#FFFFFF", // Blanc pur
      text: "#4A3428", // Brun chocolat doux
      textSecondary: "#8B7355", // Taupe chaud
      border: "#E5D5C3", // Beige sable
      gradient:
        "linear-gradient(135deg, #B85C47 0%, #D4A574 40%, #E8B969 100%)",
    },
    fonts: {
    ...
    imagery: {
      backgroundPattern: "gilded-leaves",
      iconStyle: "outline",
  ...
  },
  {
    ...
    colors: {
      ...
      border: "#90EE90",
      gradient:
        "radial-gradient(ellipse at top, #F0FFF0 0%, #98FB98 25%, #FFB6C1 50%, #32CD32 100%)",
    },
    fonts: {
      primary: "'Inter', sans-serif",
  ...
  // === THÈMES CORPORATE ===
  {
    ...
    colors: {
      ...
      border: "#E2E8F0",
      gradient:
        "linear-gradient(135deg, #3B82F6 0%, #6366F1 25%, #8B5CF6 50%, #06B6D4 100%)",
    },
    fonts: {
      primary: "'Inter', sans-serif",
  ...
  },
  {
    ...
    colors: {
      ...
      border: "#D1D5DB",
      gradient:
        "linear-gradient(145deg, #1F2937 0%, #374151 20%, #F59E0B 60%, #EAB308 100%)",
    },
    fonts: {
      primary: "'Inter', sans-serif",
  ...
  // === THÈMES ANNIVERSAIRE ===
  {
    ...
    colors: {
      ...
      border: "#F1C40F",
      gradient:
        "conic-gradient(from 0deg, #FF4757, #FFA502, #3742FA, #FF6B9D, #FF4757)",
    },
    fonts: {
  ...
  },
  {
    ...
    colors: {
      ...
      border: "#E2E8F0",
      gradient:
        "radial-gradient(circle at 30% 40%, #8B5CF6 0%, #A855F7 25%, #EC4899 50%, #F59E0B 100%)",
    },
    fonts: {
      primary: "'Inter', sans-serif",
  ...
  // === THÈMES SAISONNIERS ===
  {
    ...
    colors: {
      ...
      border: "#90D4F7",
      gradient:
        "linear-gradient(135deg, #FF6B35 0%, #FFD700 30%, #00D9FF 70%, #06FFA5 100%)",
    },
    fonts: {
      primary: "'Nunito', sans-serif",
  ...
  },
  {
    ...
    colors: {
      ...
      border: "#D1D5DB",
      gradient:
        "radial-gradient(ellipse at bottom, #1E40AF 0%, #3B82F6 30%, #F3F4F6 70%, #EF4444 100%)",
    },
    fonts: {
      primary: "'Inter', sans-serif",
      heading: "'Merriweather', serif",
  ...
  // === THÈMES PARTY ===
  {
    ...
    colors: {
      ...
      border: "#FF0080",
      gradient:
        "conic-gradient(from 90deg, #FF0080, #00FFFF, #39FF14, #FF6B00, #8A2BE2, #FF0080)",
    },
    fonts: {
  ...
  },
  {
    ...
    colors: {
      ...
      border: "#F8BBD9",
      gradient:
        "linear-gradient(45deg, #FF1744 0%, #E91E63 20%, #9C27B0 40%, #673AB7 60%, #3F51B5 80%, #FF9800 100%)",
    },
    fonts: {
  ...
  },
  {
    ...
    colors: {
      ...
      border: "#30363D",
      gradient:
        "linear-gradient(135deg, #00D4FF 0%, #FF006E 25%, #8338EC 50%, #3A86FF 75%, #06FFA5 100%)",
    },
    fonts: {
  ...
  },
  {
    ...
    colors: {
      ...
      border: "#BDC3C7",
      gradient:
        "radial-gradient(ellipse at center, #F8FDF8 0%, #A8E6CF 30%, #88D8A3 60%, #2ECC71 100%)",
    },
    fonts: {
      primary: "'Nunito', sans-serif",
  ...
  },
  {
    ...
    colors: {
      ...
      border: "#F39C12",
      gradient:
        "linear-gradient(135deg, #FF6B6B 0%, #FF8E53 20%, #FF6B9D 40%, #C44569 60%, #F8B500 80%, #4ECDC4 100%)",
    },
    fonts: {
  ...
  },
  {
    ...
    colors: {
      ...
      border: "#0077BE",
      gradient:
        "radial-gradient(ellipse at top, #F0F8FF 0%, #CAF0F8 20%, #90E0EF 40%, #00B4D8 60%, #0077BE 80%, #003566 100%)",
    },
    fonts: {
  ...
  },
  {
    ...
    colors: {
      ...
      border: "#4C4C6D",
      gradient:
        "radial-gradient(ellipse at center, #0F0F23 0%, #16213E 20%, #8B5A96 40%, #6A4C93 60%, #F72585 80%, #4895EF 100%)",
    },
    fonts: {
