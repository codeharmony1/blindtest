    ...
    <div class="pricing-page">
      ...
      <section class="hero">
        <div class="hero-content">
          <h1>🎵 Tarifs Blind Test Musical</h1>
          <p class="hero-subtitle">
            Choisissez le plan qui convient à vos besoins.<br />
            Commencez gratuitement avec le plan DÉMO.
          </p>
      ...
      <section class="cta-section">
        ...
        <p>Créez votre compte gratuitement et organisez votre premier blind test dès maintenant !</p>
        <button class="btn btn-large btn-primary" routerLink="/auth/register">
...
export class PricingComponent implements OnInit {
  ...
  selectPlan(plan: string): void {
    // Vérifie tous les tokens possibles (tenant, access, super admin)
    ...
    const successUrl = `${window.location.origin}/pricing/success?session_id={CHECKOUT_SESSION_ID}`;
