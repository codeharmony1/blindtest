        ...
        <form [formGroup]="roundForm" (ngSubmit)="onSubmit()" class="round-form-content">
            ...
            <div class="form-grid">
              ...
              <div class="form-group">
                ...
                <input
                  ...
                  max="100"
                  placeholder="20">
                <div *ngIf="roundForm.get('totalSongs')?.errors?.['required'] && roundForm.get('totalSongs')?.touched"
                     class="form-error">
                  Le nombre de chansons est obligatoire
                </div>
                <div *ngIf="roundForm.get('totalSongs')?.errors?.['min'] && roundForm.get('totalSongs')?.touched"
                     class="form-error">
              ...
              <div class="form-group">
                ...
                <input
                  ...
                  placeholder="15">
                <small class="form-help">
                  Durée par défaut pour chaque chanson de ce round
                </small>
                <div *ngIf="roundForm.get('defaultDuration')?.errors?.['required'] && roundForm.get('defaultDuration')?.touched"
                     class="form-error">
          ...
          <div class="form-actions">
            ...
            <button
              ...
              <span *ngIf="!isSubmitting">{{ isEdit ? '💾 Sauvegarder' : '✨ Créer le round' }}</span>
            </button>
          </div>
        </form>
...
export class RoundFormComponent implements OnInit {
  ...
  onSubmit() {
    if (this.roundForm.valid && this.currentEvent) {
      ...
      this.http.post(`http://localhost:3000/api/events/${this.currentEvent.code}/rounds`, roundData)
        .subscribe({
          next: (response) => {
